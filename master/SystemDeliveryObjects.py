class Status(object):
    ...
    def __init__(self, _name, _chron, _data, _type ):
...
class Status_Processes(Status):
    ...
    def __init__(self, _name, _chron, _data ):
        ...
        self.__processList = self.fields
    ...
    # end of toString()
# end of the discription of class Status_Processes
...
class SystemCall(object):
    ...
    def __init__(self, _sender, _content):
        ...
        data = _content.split( " " )
        # clock example:clock change 30
        # kill example:kill process pid
        # alarm example:alarmData change name;cpu_limit;mem_limit;cpu_count_limit;mem_count_limit

        if data[0] == "clock" or data[0] == "kill" or data[0] == "alarmData":
